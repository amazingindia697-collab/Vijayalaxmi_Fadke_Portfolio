    ...
    <div className="py-24 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <a href="mailto:vijayalaxmifadke@gmail.com" className="group flex flex-col items-center p-10 bg-zinc-900 border border-zinc-800 rounded-[2.5rem] hover:border-emerald-500/50 transition-all shadow-xl">
